...
def zeroshot_title_score_batch(candidates):
    ...
    try:
        ...
        # ★ 개선된 라벨: 표 제목 vs 비제목 명확히 구분
        labels = [
            "표(table)의 제목/캡션: 표 내용을 설명하는 짧은 명사구. '표 3.1', 'Table 2', '〈표〉' 포함 또는 간결한 명사",
            "문서의 절/항 제목: 괄호 번호 '(1)', 동그라미 '①', 다단계 '1.2.3', 기호 '가.' 등으로 시작하는 긴 제목",
            "페이지 번호/헤더/푸터: '│' 기호, '- 1 -', 'Page' 등 페이지 정보",
            "설명 문장/본문: 서술형으로 동사 어미 '~다', '~한다', '~된다'로 끝남",
            "수식/계산식: 등호, 곱하기, 괄호, 분수가 많은 수학 표현식",
            "단위/주석/비고: '단위:', '비고:', '출처:', '[...]', '주)' 등",
        ]
        ...
        # ★ 라벨별 가중치
        base_weights = {
            "표(table)의 제목/캡션: 표 내용을 설명하는 짧은 명사구. '표 3.1', 'Table 2', '〈표〉' 포함 또는 간결한 명사": 1.0,
            "문서의 절/항 제목: 괄호 번호 '(1)', 동그라미 '①', 다단계 '1.2.3', 기호 '가.' 등으로 시작하는 긴 제목": -0.5,
            "페이지 번호/헤더/푸터: '│' 기호, '- 1 -', 'Page' 등 페이지 정보": -0.95,
            "설명 문장/본문: 서술형으로 동사 어미 '~다', '~한다', '~된다'로 끝남": -0.85,
            "수식/계산식: 등호, 곱하기, 괄호, 분수가 많은 수학 표현식": -0.75,
            "단위/주석/비고: '단위:', '비고:', '출처:', '[...]', '주)' 등": -0.95,
        }
